...
class Tag extends \GeniusKSDK\XML {

    private $table = 'ContactGroup';
    ...
    public function list(array $struct = null) {
        ...
        $params = array_values($this->restruct($this->defaultQueryFilter(array('Id', 'GroupName', 'GroupCategoryId', 'GroupDescription')), $struct));
    ...
    protected function defaultTagStruct() {
        return array(
            'GroupName' => '',
            'GroupCategoryId' => 0,
            'GroupDescription' => 'Added via API using GeniusKSDK'
        );
    }
}
